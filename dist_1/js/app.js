(() => {
    ...
    function initSliders() {
        ...
        if (document.querySelector(".website__slider")) new core(".website__slider", {
    ...
    window.onload = function() {
        ...
        if (life && !isMobile.any()) {
            ...
            function setMouseGalleryStyle() {
                ...
                if (Math.abs(distX) > 0) requestAnimationFrame(setMouseGalleryStyle); else life.classList.remove("_init");
            }
